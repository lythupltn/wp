...
class Font_Icons extends Assets_Base {
	public function register() {
		parent::register();
		add_action('customize_controls_enqueue_scripts',array($this,'enqueue_control'));
	}
	public static function get_font_icons( $font_icon ) {
		$icons = array();
		if('font-awesome' == $font_icon){
			$icons = array(
				'font-awesome' => array(
					'name'         => __( 'FontAwesome', 'laser' ),
					'icons'        => array(
						0   => 'fa-glass',
						1   => 'fa-music',
						2   => 'fa-search',
	...
	public function get_vendor_styles() {
		return array(
			'font-awesome' => array(
				'url'     => $this->plugin_url . 'assets/vendors/font-awesome-4.7.0/css/font-awesome.min.css',
				'deps'    => array(),
				'version' => '4.7.0',
				'media'   => 'all'
			)
