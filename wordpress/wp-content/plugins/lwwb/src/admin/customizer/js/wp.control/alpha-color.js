...
lwwb.Control.Wp['color-picker'] = {
		...
		init: function($ctr) {
			...
			this.$control.find('.lwwb-control-lwwb-color-picker').each(function() {
				...
				$control = $(this).find('.alpha-color-control');
				...
				alphaVal = lwwb_get_alpha_value_from_color( startingColor );
				...
				$alphaSlider.slider().on(
					'slide', function( event, ui ) {
						...
						lwwb_update_alpha_value_on_color_control( alpha, $control, $alphaSlider, false );
